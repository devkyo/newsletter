      ...
      <div class="row">
        <div class="col-md-6 col-12">
          ...
          <div class="form-group">
            ...
            <input type="text" id="email" name="email" placeholder="mi@correo.com" class="form-control @error('email') is-invalid @enderror" value="{{ $user->email }}" disabled>
            @error('email')
              <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
              </span>
        ...
        <div class="col-md-6 col-12">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="rol" name="rol_id" value="{{ $user->rol }}">
              <option hidden value="">Seleciona un rol</option>
