  ...
  <table style="width:100%;max-width:600px;padding:10px;margin:0 auto;border-collapse:collapse;font-family:Open Sans;color:#1b3b4a;background-color:#f0eada;">
    ...
    <tr>
      <td style="text-align:center;margin: 0 auto;padding:.5em 0;background:url('https://i.postimg.cc/Zq5WB6db/bg-left.jpg')no-repeat bottom left">
        <h4 style="margin:0 0 .5em 0;font-size:1.2em;font-weight: normal;">{{ $msg['address'] }}, <strong>{{ $msg['district'] }}</strong></h4>
        <a style="display:inline-block;padding:2em 0;" target="_blank" href="https://api.whatsapp.com/send?phone={{ $msg['phone'] }}&text=Hola,%20estoy%20deseo%20m%C3%A1s%20informaci%C3%B3n%20del%20proyecto%20ATOM"><img style="display:block;margin: 0 auto" src="https://i.postimg.cc/yNpkFWmF/whatsapp.jpg" alt=""></a>
        <p style="box-sizing:border-box;text-align:justify;max-width:320px;margin:0 auto;padding:0.5em 10px;font-size:14px;line-height: 1.5;">
    ...
    <tr>
      <td style="text-align:center;margin:0 auto;padding:.5em 0; display:flex;justify-content: center;color:#1b3b4a;align-items: center;">
        <div style="width:80px;;height:80px;border-radius: 50%;overflow: hidden;"><img width="100" src="{{ public_path() }}/profiles/{{ $msg['avatar'] }}" alt=""></div>
        <div style="display:flex;flex-direction: column; text-align:left;margin-left: 12px">
          <p style="margin:0;text-align: left;"><strong>{{ $msg['fullname'] }}</strong> </p>
            <span style="font-size: 11px;">{{ $msg['charge'] }}</span>
            <span style="font-size: 11px;">{{ $msg['email_asesor'] }}</span>
        </div>
      </td>
    </tr>
    <tr>
      <td style="text-align:center;margin:0 auto">
        <a style="display:inline-block;padding-bottom:2em" target="blank_" href="https://api.whatsapp.com/send?phone={{ $msg['phone'] }}&text=Hola,%20estoy%20deseo%20m%C3%A1s%20informaci%C3%B3n%20del%20proyecto%20ATOM"><img style="display:block;margin: 0 auto" src="https://i.postimg.cc/yNpkFWmF/whatsapp.jpg" alt=""></a>
      </td>
    </tr>
    <tr>
